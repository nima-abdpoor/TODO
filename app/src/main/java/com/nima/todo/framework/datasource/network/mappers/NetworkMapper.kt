package com.nima.todo.framework.datasource.network.mappers
...
constructor(
    ...
    override fun mapToEntity(domainModel: Note): NoteNetworkEntity {
        return NoteNetworkEntity(
            ...
            updated_at = dateUtil.convertStringToTimestamp(domainModel.updated_at),
            created_at = dateUtil.convertStringToTimestamp(domainModel.created_at)
        )
    }
}
